...
<body class="gray-bg">
		...
		<div id="toolbar" class="btn-group">
			<c:forEach items="${operationList}" var="oper">
			 ...
			 <div class="col-lg-2">
			  ...
			  <option value="${d.scid }">${d.scname }</option>
										</c:forEach>
                	</select>
				</div>
			 </div>
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="xzxg" role="dialog" aria-labelledby="xzxg" aria-hidden="true">
                   ...
                   <input type="hidden" name="pic" id="pic" value="1"/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>员工生日</td>
								<td><input type="date" id="stime" name="stime"
									class="form-control" aria-required="true" required/></td>
							</tr>
		                    <tr>
							<td>员工性别</td>
	...
	<!-- 导入对话框 -->
	<div class="modal fade" id="modal_user_daoru" role="dialog" aria-labelledby="modal_user_daoru" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_dr" method="post" action="daoru.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>图片：</td>
								<td>
								<input type="file" name="exc" aria-required="true" required>
								</td>
							</tr>
						</table>
						<div class="modal-footer">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	  	    		  ...
	  	    		  var tb=echarts.init(document.getElementById("bingtu"));
	  		    		...
	  		    		$.ajax({
	  		    		    ...
	  		    		    success:function(res){
	  		    		    	obj = $.parseJSON(res);			
	  		    				for(var i=0;i<obj.length;i++){
	  		    					zztj[i]={value: obj[i].num, name: obj[i].cname};
	  		    				}
	  		    				option = {
	  		    					    series: [
	  		    					        {
	  	...
	  	function initEditUser(getSelection){
	  		...
	  		$('#stime').val(new Date(getSelection.stime).Format('yyyy-MM-dd'));
