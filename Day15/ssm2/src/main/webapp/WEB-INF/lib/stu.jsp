							...
							<td>员工性别</td>
								...
								<td><input type="text" id="code" name="code"
									class="form-control" aria-required="true" required/></td>
													...
													<td>所属年纪：</td>
								<td>
								<input type="checkbox" id="grade1" name="grade"  value="一年级"/>一年级
								<input type="checkbox" id="grade2" name="grade"  value="二年级"/>二年级
								<input type="checkbox" id="grade3" name="grade"  value="三年级"/>三年级
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	  	...
	  	function initEditUser(getSelection){
	  		...
	  		var hop=getSelection.grade.split(",");
