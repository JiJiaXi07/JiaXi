...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body"> 
					<form id="form_emp" method="post" action="reserveStu.htm" >
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
							   ...
							   <tr>
								     ...
								     <input type="radio" name="sdsex" id="sdsex" value="女"/>女</td>
								</tr> 
								 <tr>
													<td>爱好</td>
								<td>
								<input type="checkbox" id="sdhobby1" name="sdhobby"  value="吃"/>吃
								<input type="checkbox" id="sdhobby2" name="sdhobby"  value="喝"/>喝
								<input type="checkbox" id="sdhobby3" name="sdhobby"  value="拉"/>拉
								...
								<td colspan="4">
									<select class="form-control" name="mid" id = "mid" aria-required="true" required>
										...
										<c:forEach items="${deptList }" var="d">
										 	<option value="${d.mdId }">${d.mdname }</option>
										</c:forEach>
				                	</select>
								</td>
							</tr>
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="mqdiv" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body"> 
					<form id="from_mq" method="post" action="mqmq.htm" >
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_mq_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    var validator = $("#from_mq").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	    ...
	    $("#submit_form_mq_btn").click(function(){
	    	$("#from_mq").submit();
	    });
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#mq").click(function(){
	    		...
	    		$('#mqdiv').modal({backdrop: 'static', keyboard: false});
				$('#mqdiv').modal('show');
	        });
	  	...
	  	function initEditUser(getSelection){
        	...
        	$("input[value='"+getSelection.sdsex+"']").prop('checked',true);
	  		...
	  		var hop=getSelection.sdhobby.split(",");
